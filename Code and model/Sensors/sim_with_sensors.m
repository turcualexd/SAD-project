...
kp = (I2 - I1)/I3;
figure;
plot(-1*ones(100,1), linspace(-1,1,100),'Color','b');
hold on;
plot(1*ones(100,1), linspace(-1,1,100),'Color','b');
plot(linspace(-1,1,100),ones(100,1),'Color','b');
plot(linspace(-1,1,100),-1*ones(100,1),'Color','b');
plot(zeros(100), linspace(-1,1,100),'Color','b');
plot(linspace(-1,1,100),zeros(100),'Color','b')
plot(kr, ky, 'Marker','o');
plot(linspace(-1,1,100), linspace(-1,1,100), 'Color', 'r')
axis equal;
