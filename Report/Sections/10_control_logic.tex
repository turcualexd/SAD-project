...
$$\boldsymbol{M}_c=-k_1\boldsymbol{\alpha}-k_2\boldsymbol{{\omega}_{BL}}$$
...
\end{itemize}
The poles chosen are: ...., the gain matrix gain can be used for the linear-control law. From here, the order of magnitude of the gain matrix was selected and it is:.... This values has been used in the non-linear control law of equation (...) and then refined with trial and error. The response of the system was satisfactory with the following values:
